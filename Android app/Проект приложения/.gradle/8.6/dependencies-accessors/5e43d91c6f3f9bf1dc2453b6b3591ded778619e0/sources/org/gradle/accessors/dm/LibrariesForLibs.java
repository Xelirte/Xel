...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class MysqlConnectorLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>mysqlConnectorJava</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RoomCompilerLibraryAccessors extends SubDependencyFactory {
        private final RoomCompilerProcessingLibraryAccessors laccForRoomCompilerProcessingLibraryAccessors = new RoomCompilerProcessingLibraryAccessors(owner);

        public RoomCompilerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>room.compiler.processing</b>
         */
        public RoomCompilerProcessingLibraryAccessors getProcessing() {
            return laccForRoomCompilerProcessingLibraryAccessors;
        }

    }

    public static class RoomCompilerProcessingLibraryAccessors extends SubDependencyFactory {

        public RoomCompilerProcessingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getTesting() {
            return create("room.compiler.processing.testing");
        }

    }

    public static class TracingLibraryAccessors extends SubDependencyFactory {
    ...
    public static class TracingPerfettoLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getHandshake() {
            return create("tracing.perfetto.handshake");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mysqlConnectorJava</b> with value <b>8.0.33</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMysqlConnectorJava() { return getVersion("mysqlConnectorJava"); }
